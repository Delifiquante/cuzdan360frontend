    ...
    const handleMove = useCallback(
      (e?: MouseEvent | { clientX: number; clientY: number }) => {
        ...
        animationFrameRef.current = requestAnimationFrame(() => {
          ...
          let targetAngle =
            (180 * Math.atan2(relY - center[1], relX - center[0])) /
              Math.PI +
            90;
          ...
          animate(element, { '--start': newAngle }, {
          ...
          style={
            {
              ...
              "--gradient":
                `repeating-conic-gradient(from 0deg, #528435 0%, #528435 5%, transparent 5%, transparent 40%, #528435 50%)`,
