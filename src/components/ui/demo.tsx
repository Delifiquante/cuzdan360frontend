...
export default function Example() {
    return (
        <div className="max-w-5xl w-full mx-auto p-10 text-foreground">
            <span className="px-2 py-1 text-xs border border-gray-500 rounded-full">Bize Ulaşın</span>
            <h1 className="text-4xl font-bold text-left mt-4 text-foreground">
            ...
            <div className="grid md:grid-cols-3 mt-16">
                <div>
                    ...
                    <p className="text-lg font-bold mt-2 text-foreground">E-posta Desteği</p>
                    <p className="text-muted-foreground mt-1 mb-4">Ekibimiz gerçek zamanlı olarak yanıt verebilir.</p>
                    <a href="mailto:akemalturgut@yahoo.com" className="text-[#68a146] font-semibold">
                        akemalturgut@yahoo.com
                    </a>
                </div>
                <div>
                    <svg className="text-[#68a146] bg-[#68a146]/20 p-2.5 aspect-square rounded-full size-10" width="24"
                    ...
                    <p className="text-lg font-bold mt-2 text-foreground">Ofisimizi Ziyaret Edin</p>
                    <p className="text-muted-foreground mt-1 mb-4">Konumuzu gerçek hayatta ziyaret edin.</p>
                    <span className="text-[#68a146] font-semibold">
                        Trakya Üniversitesi
                    </span>
                </div>
                <div>
                    <svg className="text-[#68a146] bg-[#68a146]/20 p-2.5 aspect-square rounded-full size-10" width="21"
                    ...
                    <p className="text-lg font-bold mt-2 text-foreground">Bizi Doğrudan Arayın</p>
                    <p className="text-muted-foreground mt-1 mb-4">Çalışma saatleri içinde bize ulaşabilirsiniz.</p>
                    <span className="text-[#68a146] font-semibold">
                        (+90) 555 555 55 55
                    </span>
                </div>
