...
const Pricing2 = ({
  heading = "Planlar & Fiyatlandırma",
  description = "İş akışınıza uygun planı seçin ve kolayca ölçeklendirin.",
  plans = [
    {
      id: "starter",
      name: "Başlangıç",
    ...
    },
    {
      id: "growth",
      name: "Büyüme",
      description: "Ciddi ürünler geliştiren ekipler için",
      monthlyPrice: "129.99₺",
      features: [
        { text: "Sınırsız proje" },
        { text: "Ekip işbirliği araçları" },
        { text: "Öncelikli sohbet desteği" },
    ...
    },
     {
      ...
      monthlyPrice: "229.99₺",
      features: [
        { text: "Tüm Büyüme özellikleri" },
        { text: "Özel marka bilinci oluşturma" },
        { text: "Özel hesap yöneticisi" },
        { text: "Kurumsal düzeyde destek" },
      ],
      button: {
