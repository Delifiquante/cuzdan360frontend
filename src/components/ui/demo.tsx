...
export default function Example() {
    return (
        <div className="max-w-5xl w-full mx-auto p-10 text-white">
            ...
            <div className="grid md:grid-cols-3 mt-16">
                <div>
                    ...
                    <p className="text-lg font-bold mt-2">E-posta Desteği</p>
                    <p className="text-neutral-300 mt-1 mb-4">Ekibimiz gerçek zamanlı olarak yanıt verebilir.</p>
                ...
                <div>
                    ...
                    <p className="text-lg font-bold mt-2">Ofisimizi Ziyaret Edin</p>
                    <p className="text-neutral-300 mt-1 mb-4">Konumuzu gerçek hayatta ziyaret edin.</p>
                ...
                <div>
                    ...
                    <p className="text-lg font-bold mt-2">Bizi Doğrudan Arayın</p>
                    <p className="text-neutral-300 mt-1 mb-4">Çalışma saatleri içinde bize ulaşabilirsiniz.</p>
                    <span className="text-[#68a146] font-semibold">
                        (+90) 555 555 55 55
                    </span>
                </div>
